...
elseif(stristr($host, "localhost") !== FALSE || (stristr($host, '192.168.') !== FALSE) || (stristr($host, '127.0.0') !== FALSE)){
	$config['base_url'] = $protocol.$host.'/ci_para_base/';
}else{
	$allowed_hosts = array('learning.underlink.eu');
...
$config['site_name'] = 'Para';
$config['site_description'] = 'Full Stack Development';
